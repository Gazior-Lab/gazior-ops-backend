...
class TaskService:
    ...
    async def create_task(self, task_data: TaskCreate, current_user_id: UUID) -> Task:
    ...
    async def archive_task(self, task_id: UUID, current_user_id: UUID) -> Optional[Task]:
        """Archive a task"""
        return await self.task_repo.archive(task_id, current_user_id)

    async def unarchive_task(self, task_id: UUID, current_user_id: UUID) -> Optional[Task]:
        """Unarchive a task"""
